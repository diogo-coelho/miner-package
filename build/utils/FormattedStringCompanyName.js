...
const ErrorStringCompanyName_1 = __importDefault(require("./../errors/ErrorStringCompanyName"));
class FormattedStringCompanyName {
    ...
    replaceCaracterEspecial(companyName) {
        try {
            ...
            throw new ErrorStringCompanyName_1.default(err);
        }
    }
    replaceTipoEmpresa(companyName) {
        try {
            const sigla = [
                " A.G ",
                " AG. ",
